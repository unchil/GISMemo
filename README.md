...
|  :----:         |:----------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| List   | <img src="https://github.com/unchil/GISMemo/blob/main/docu/resource/gismemo_list_portrait.jpg"  width="200px" title="list_portrait" alt="테스트"></img> | <img src="https://github.com/unchil/GISMemo/blob/main/docu/resource/gismemo_list_landscape.jpg"  width="400px" title="list_landscape" alt="테스트"></img> | It is a list screen of created memos, and features such as search, share, delete, and view details are provided.                                                                                                         |
