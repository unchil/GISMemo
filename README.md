...
This GISMemo is a memo program based on Google Map.
Weather information provided by OpenWeather and snapshots from Google Map are included by default when creating notes.
...
Google Map: [Google][googlelink]

[googlelink]: https://developers.google.com/maps "Go google"