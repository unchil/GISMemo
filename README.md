...
|  :----:         |:--------------------------------------------------------------------------------------------------------------------------------------------:|          :----  |
| List   | <img src="https://github.com/unchil/GISMemo/blob/main/docu/resource/gismemo_list_portrait.jpg"  width="600px" title="전체 맵" alt="테스트"></img>  |  It is a list screen of created memos, and features such as search, share, delete, and view details are provided.     |
